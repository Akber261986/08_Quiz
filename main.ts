...
if (quiz.q1 == "tsc --init"){correct++}
else{incorrect++}

if (quiz.q2 == "3"){correct++}
else{incorrect++}

if (quiz.q3 == "if"){correct++}
else{incorrect++}

if (quiz.q4 == "cosnt"){correct++}
else{incorrect++}

if (quiz.q5 == "main.ts"){correct++}
else{incorrect++}

if (quiz.q6 == "JavaScript"){correct++}
else{incorrect++}

if (quiz.q7 == "tsc main.ts"){correct++}
else{incorrect++}

if (quiz.q8 == "None of Above"){correct++}
else{incorrect++}

if (quiz.q9 == "Super Set"){correct++}
else{incorrect++}

if (quiz.q10 == ".push()"){correct++}
else{incorrect++}

if (quiz.q11 == ".unshift()"){correct++}
else{incorrect++}

if (quiz.q12 == ".pop()"){correct++}
else{incorrect++}

if (quiz.q13 == "38"){correct++}
else{incorrect++}

if (quiz.q14 == "false condition"){correct++}
else{incorrect++}
